...
_SHOP_LEAD_SUCCESS_TITLE = _("Thank you")
_SHOP_LEAD_SUCCESS_MESSAGE = _(
...
def _apply_shop_lead_success_context(context) -> None:
	...
	url = get_url("/shops")
	context.success_title = _SHOP_LEAD_SUCCESS_TITLE
	context.success_message = _SHOP_LEAD_SUCCESS_MESSAGE
	context.success_url = url
	wd = getattr(context, "web_form_doc", None)
	if isinstance(wd, dict):
		wd["success_title"] = _SHOP_LEAD_SUCCESS_TITLE
		wd["success_message"] = _SHOP_LEAD_SUCCESS_MESSAGE
		wd["success_url"] = url
